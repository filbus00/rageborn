...
- `EnemyDefinition` (ScriptableObject) holds the tuning. Its values marked as tuning are not in the docs yet. Existing states are Idle, Approach and Return; Attack, Recover and Death come with combat.
